 ...
 */
ob_end_clean();
require_once("./fpdf/constancia_bajos_recursos.class");
...
$ci = $_GET['ci'];
$ob = $_GET['ob'];
$query = "SELECT cedula, apellido, nombre FROM encuestas.censo WHERE cedula = '$ci'";
...
if ($numrows > 0)
{
    ...
    $texto = "Quienes suscriben miembros del Consejo Comunal \"\", ubicado en la Pedregosa Alta, Parroquia Lasso de la Vega, Municipio Libertador del Estado Mérida, por medio de la presente certificamos que el (la) Ciudadano (a): $apellido, $nombre de nacionalidad ______________ (a), titular de la Cédula de Identidad $cedula, es una persona de bajos recursos económicos.";
...
$pdf->Output("Bajos_Recursos.pdf",'I');
?>
