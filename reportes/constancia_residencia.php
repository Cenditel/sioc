 ...
 */
ob_end_clean();
require_once("./fpdf/constancia_residencia.class");
...
if ($numrows > 0)
{
    ...
    $texto = "Quienes suscriben miembros del Consejo Comunal \"\", ubicado en la ___________, Parroquia __________, Municipio ______________ del Estado Mérida, por medio de la presente certificamos que el (la) Ciudadano (a): $apellido, $nombre de nacionalidad ______________ (a), titular de la Cédula de Identidad $cedula, reside en: $sector, desde aproximadamente: ________________.";
