 ...
 * @package SIOC
 */
class constancia_concubinato extends P4A_Base_Mask
{
    public function __construct()
    {
        ...
        $this->build("p4a_fieldset","fs_concubinato")
    ...
    public function imprimirConsulta0($object)
    {
        ...
        P4A_Redirect_To_Url("./reportes/constancia_concubinato.php?ci={$ci}&ob={$ob}");
    }
}
