 ...
 * Tabla:	tabla11
 * Tipo:	Básica
 * Tema:	Material predominante de las paredes exteriores
 * <Descripcion: tabla básica para registrar los tipos de materiales
 * de los que pueden estar hechos las paredes exteriores>
 */
class tabla11 extends P4A_Simple_Edit_Mask
{
    public function __construct()
    {
        ...
        $this->setTitle("Material Utilizado en las Paredes Exteriores");
        ...
        $this->display("menu", $p4a->menu)
            ->setFocus($this->fields->tabla11_campo2);
    }
    ...
    private function camposObligatorios()
    {
         ...
         */
        $this->setRequiredField("tabla11_campo2");
    ...
    private function propiedadesCampos()
    {
        ...
        $this->fields->tabla11_campo2
        	->setLabel("Descripción")
        	->setWidth(200)
        	->setProperty('maxlength',"50")
        	->addValidator(new P4A_Validate_Alpha(true),true);
        $this->fields->tabla11_campo3->setLabel("Visible");

        $this->fields->tabla11_campo2->label->setWidth(120);
        $this->fields->tabla11_campo3->label->setWidth(120);
 ...
 */
		try
		{
            ...
            $tabla11_campo1 = $this->fields->tabla11_campo1->getSQLValue();
            $tabla11_campo2 = $this->fields->tabla11_campo2->getSQLNewValue();
            $tabla11_campo3 = $this->fields->tabla11_campo3->getSQLNewValue();

            $existe = "SELECT count(*) FROM cc1.tabla11 WHERE tabla11_campo3 = true AND activo = '$tabla11_campo3' AND tabla11_campo2 ILIKE('$tabla11_campo2'); ";
            $this->user_data = $p4a_db->fetchRow($existe);
            if ($this->user_data['count'] >= 1) {
                $this->warning("El registro ya existe");
                $this->setFocus($this->fields->tabla11_campo2);
                return;
            }

            $query = "INSERT INTO cc1.tabla11 (tabla11_campo2, tabla11_campo3) VALUES (INITCAP('$tabla11_campo2'), '$tabla11_campo3')";
            $p4a_db->query($query);
            if ($tabla11_campo1)
                P4A_DB::singleton()->query("UPDATE cc1.tabla11 SET activo = 'false' WHERE tabla11_campo1 = $tabla11_campo1");
