 ...
 * @package SIOC
 */
class constancia_residencia extends P4A_Base_Mask
{
    public function __construct()
    {
        ...
        $this->build("p4a_fieldset","fs_residencia")
            ->setLabel("Constancia de Residencia")
            ->setWidth(900)
    ...
    public function imprimirConsulta0($object)
    {
        ...
        P4A_Redirect_To_Url("./reportes/constancia_residencia.php?ci={$ci}&ob={$ob}");
    }
}
